...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function clickSplat(pointer: Pointer) {
      ...
      // Увеличиваем яркость для эффекта белых облаков
      color.r *= 0.1;
      color.g *= 0.1;
      color.b *= 0.1;
    ...
    function generateColor(): ColorRGB {
      // Белые облака - почти белый цвет с очень легким голубым оттенком
      const c = HSVtoRGB(0.6, 0.02, 0.95); // Голубой оттенок с очень низкой насыщенностью и высокой яркостью
      c.r *= 0.85;
      c.g *= 0.9;
      c.b *= 0.95;
      return c;
