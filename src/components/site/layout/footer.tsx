...
const navigationLeft = [
  /* The above code appears to be a TypeScript React object with a key-value pair containing a href and
  label for a link to the pricing section on a webpage. */
  ...
  return (
    <footer className="w-full pt-[50px] pb-[50px] px-4 select-none relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          background: `
            radial-gradient(ellipse 600px 400px at 0% 100%, rgba(106, 190, 230, 0.9) 0%, rgba(106, 190, 230, 0.6) 20%, rgba(106, 190, 230, 0.3) 40%, transparent 70%),
            radial-gradient(ellipse 400px 300px at 10% 90%, rgba(106, 190, 230, 0.8) 0%, rgba(106, 190, 230, 0.4) 30%, rgba(106, 190, 230, 0.1) 50%, transparent 70%),
            radial-gradient(ellipse 300px 200px at 5% 95%, rgba(106, 190, 230, 0.7) 0%, rgba(106, 190, 230, 0.3) 40%, transparent 60%)
          `,
          filter: 'blur(4px)',
          zIndex: 0
        }}
      ...
      <div 
        ...
        style={{
          background: `
            radial-gradient(ellipse 300px 200px at 0% 100%, rgba(106, 190, 230, 0.8) 0%, rgba(106, 190, 230, 0.5) 25%, rgba(106, 190, 230, 0.2) 45%, transparent 70%),
            radial-gradient(ellipse 200px 150px at 10% 90%, rgba(106, 190, 230, 0.6) 0%, rgba(106, 190, 230, 0.3) 35%, transparent 60%),
            radial-gradient(ellipse 150px 100px at 5% 95%, rgba(106, 190, 230, 0.5) 0%, rgba(106, 190, 230, 0.2) 40%, transparent 65%)
          `,
          filter: 'blur(3px)',
          zIndex: 0
        }}
      />
      {/* Эффект распыления вдоль правого края - mobile only */}
