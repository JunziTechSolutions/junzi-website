...
const CARD_STYLES = {
  base: {
    width: '100%',
    maxWidth: 'clamp(240px, 65vw, 493px)',
    height: 'auto',
    minHeight: 'clamp(200px, 30vh, 466px)',
    background: 'white',
...
const TYPOGRAPHY_STYLES = {
  servicesLabel: {
    ...
    fontWeight: 600,
    fontStyle: 'normal',
    fontSize: 'clamp(12.6px, 2.7vw, 19.19px)',
    lineHeight: '110%',
    letterSpacing: '8%',
  ...
  mainHeading: {
    ...
    fontWeight: 500,
    fontStyle: 'normal',
    fontSize: 'clamp(25.2px, 7.2vw, 53.71px)',
    lineHeight: '120%',
    letterSpacing: '-3%',
    textAlign: 'center' as const,
  ...
  serviceTitle: {
    ...
    fontWeight: 500,
    fontStyle: 'normal',
    fontSize: 'clamp(14.4px, 3.15vw, 18.76px)',
    lineHeight: '113%',
    letterSpacing: '0%',
  ...
  serviceDescription: {
    ...
    fontWeight: 300,
    fontStyle: 'normal',
    fontSize: 'clamp(10.8px, 2.25vw, 12.65px)',
    lineHeight: '100%',
    color: '#000000',
  },
  learnMore: {
    ...
    <>
      <style>{`
        ...
        @media (max-width: 749px) {
          ...
          .service-description { font-size: 12px !important; line-height: 120% !important; }
          .service-learn { font-size: 11px !important; }
        ...
        @media (min-width: 370px) and (max-width: 440px) {
          .service-card-wrap { max-width: 90vw !important; }
        }
            ...
            <div className="absolute inset-0 services-frame-mobile -z-10 pointer-events-none">
             ...
             <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-3 sm:gap-5 md:gap-7 p-3 pt-16 pb-10 sm:p-7 sm:pt-0 md:p-14 md:pt-20 justify-items-center">
              {services.map((service) => (
                <div key={service.title} className="service-card-wrap group p-[1px] rounded-[14px] sm:rounded-[18px] md:rounded-[25.3px] bg-white transition-colors duration-300 card-hover-gradient">
                  <div
                    onClick={openModal}
                  ...
                  >
                    ...
                    <div className="flex justify-center mb-5 sm:mb-5">
                      ...
                      />
                                         ...
                                         {/* Service Title */}
                    <h3 className="service-title text-[18px] sm:text-xl font-semibold mb-3 sm:mb-6 text-center sm:text-left" style={TYPOGRAPHY_STYLES.serviceTitle}>
                      {service.title}
                    </h3>
                    
                    {/* Service Description */}
                    <p className="service-description text-sm sm:text-sm mb-4 sm:mb-7 text-center sm:text-left" style={TYPOGRAPHY_STYLES.serviceDescription}>
                      {service.description}
                    </p>
                    
                                          {/* Learn More Link */}
                    <div className="text-center sm:text-left">
                      <span className="service-learn inline-flex items-center cursor-pointer group text-[10px] sm:text-[12px]" style={TYPOGRAPHY_STYLES.learnMore}>
