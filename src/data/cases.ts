...
export const casesData: CaseStudy[] = [
  {
    id: "worthefy",
    slug: "worthefy",
    title: "Worthefy Project – Personal Finance Platform Case Study",
    description: "Worthefy is a smart app created by Junzi Tech that uses real-time data and insights to assist users in tracking and managing their net worth.",
  ...
  },
  {
    id: "publefy",
    slug: "publefy",
    title: "Case Study: Building the Publefy Social Media Platform",
    description: "For Publefy, Junzi Tech created an AI meme generator user interface that enables movies to automatically transform into imaginative memes in matter of seconds.",
  ...
  },
  {
    id: "taxbot",
    slug: "taxbot",
    title: "Junzi Tech – Building the TaxBot AI Tax Advisor Platform",
    description: "Junzi Tech Solutions created an intelligent voice interface for TaxBot that makes filing taxes faster, more intelligent and completely error-free.",
  ...
  },
  {
    id: "eingie-energy",
    slug: "eingie-energy",
    title: "JunziDev – Eingie Energy IoT Monitoring Case Study",
    description: "Eingie Energy managed the building with a number of different tools. Junzi Tech developed a single smart dashboard to store all the data in one place.",
  ...
  
  {
    id: "wizze-ai",
    slug: "wizze-ai",
    title: "Junzi Tech Solutions: Wizze AI Custom App Dev Case",
    description: "How Junzi Tech Solutions delivered the Wizze AI app — a mobile & web app development company in USA specialising in custom app development.",
  ...
  ,
  {
    id: "irp-app",
    slug: "irp-app",
    title: "Junzi Tech Solutions | IRP Mobile App Development",
    description: "IRP App case study by Junzi Tech Solutions, a mobile app development company in USA delivering enterprise app development and custom software solutions.",
  ...
  ,
  {
    id: "astro-ai",
    slug: "astro-ai",
    title: "Junzi Tech Solutions – ASTRO AI Predictive App Case",
    description: "Junzi Tech Solutions built the ASTRO AI predictive analytics platform — enterprise app development company in USA delivering tailored software solutions.",
  ...
  ,
  {
    id: "artifex",
    slug: "artifex",
    title: "Junzi Tech Solutions – Artifex Design Platform Dev",
    description: "Junzi Tech Solutions: Artifex case study of a web-application design platform built by a mobile & web app development company in USA.",
  ...
  },
  {
    id: "shout",
    slug: "shout",
    title: "Junzi Tech Solutions – SHOUT Mobile App Case Study",
    description: "Junzi Tech Solutions: SHOUT case study of an AI-powered social media tool — an application development company full stack software development services.",
  ...
  },
  {
    ...
    title: "Patton’s Adventure Case Study | Junzi Tech Solutions",
    description: "Patton's Adventure, developed by Junzi Tech Solutions, is an educational game that mixes enjoyable gameplay with learning objectives to increase user engagement.",
  ...
  },
  {
    id: "fitness-crm",
    slug: "fitness-crm",
    title: "Fitness CRM App | Junzi Tech Solutions USA",
    description: "Junzi Tech developed a Fitness CRM Management System to help gyms and wellness centres increase member engagement and simplify daily tasks.",
  ...
  },
  {
    id: "styleconnect",
    slug: "styleconnect",
    title: "StyleConnect Case Study – Fashion-Tech Social Commerce",
    description: "StyleConnect case study by Junzi Tech Solutions, a mobile app development company in USA delivering custom app development and strong product UX design.",
  ...
  },
  {
    id: "raventi",
    slug: "raventi",
    title: "Premium E-Commerce Build for RAVENTI Sports",
    description: "The Raventi Pickleball e-commerce website was created by Junzi Tech, who optimised it for better conversions and a smooth buying experience.",
  ...
  },
  {
    id: "shabelinsky",
    slug: "shabelinsky",
    title: "Junzi Tech Solutions | Web App Dev for Fitness Studio",
    description: "Shabelinsky case study by Junzi Tech Solutions, a software development company in USA delivering custom web application development and refined UX design.",
  ...
  },
  {
    id: "phoni",
    slug: "phoni",
    title: "PHONI App Case Study | Junzi Tech Solution",
    description: "Explore the PHONI case study by Junzi Tech Solutions, a custom app development company in USA specialising in mobile game development.",
  ...
  },
  {
    id: "truckflow",
    slug: "truckflow",
    title: "Junzi Tech Solutions – TruckFlow SaaS Case Study",
    description: "TruckFlow case study by Junzi Tech Solutions, a software development company in USA focused on enterprise mobile solutions for logistics and operations.",
  ...
  },
  {
    id: "ego",
    slug: "ego",
    title: "EGO Case Study – Luxury Lifestyle Brand Platform",
    description: "See how Junzi Tech Solutions delivered custom app development for the EGO platform — mobile app development company in USA.",
