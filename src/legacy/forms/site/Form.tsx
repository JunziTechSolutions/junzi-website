          ...
          <CardHeader className="text-center pb-6">
            <div className="mb-4">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4">
                ...
                <img src="/favicon.png" className="w-22 sm:w-26 md:w-42" alt="Logo" width={60} height={60} />
          ...
          <CardContent className="p-6 space-y-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                >
                  {[
                    { value: 'Option 1', label: '$15,000 - $25,000 â€“ Launch Ready MVP', color: 'from-[#5C6BC0] to-[#3F51B5]' },
                    { value: 'Option 2', label: '$25,000 - $40,000 â€“ Custom features & design', color: 'from-[#0099CC] to-[#0066CC]' },
                    { value: 'Option 3', label: '$50,000+ â€“ Scalable with integrations', color: 'from-[#2BB673] to-[#1E8A5A]' }
                  ].map((option) => (
